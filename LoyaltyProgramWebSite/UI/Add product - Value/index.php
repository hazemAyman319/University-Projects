...
<div class="container">
    <div class="row justify-content-center h-25 mt-5">
        <form action="">
            ...
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Charity</label>
                <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="e.g. 57357">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Value</label>
                <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="e.g. 13%">
            </div>
